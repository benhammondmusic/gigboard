...
const Routes = (props) => (
  <Switch>
    ...
    <Route exact path="/login" render={() => <Login setFormEmail={props.setFormEmail} setFormPassword={props.setFormPassword} handleLogin={props.handleLogin} />} />
    ...
    {console.log(props.currentUserEmail, props.currentUserId, '@@@@')}
